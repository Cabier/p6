const http = require('http');// permet de créer un serveur
...
const errorHandler = error => {// errorHandler recherche les différentes erreurs et les gère de manière appropriée, elle est ensuite enregistré vers le serveur
